...
var deadDog,bedroom,washroom,garden,lazyDog,running,runningLeft,livingRoom,Vaccination,Injection,foodStock,dogVaccination
function preload(){
  ...
  currentTime=hour();
   if(currentTime==(lastFed+1)){ update("Playing");
    foodObj.garden();
     ...
     foodObj.washroom(); }else{ update("hungry") 
     foodObj.display();
